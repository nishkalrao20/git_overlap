...
def match(injection_parameters_a, injection_parameters_b, det, N_iter):
    ...
    for i in range(int(N_iter)):
        res = scipy.optimize.minimize(fun_mismatch, (mchirp_arr[i], eta_arr[i]), method='Nelder-Mead', options={'adaptive':True}, tol=1e-3) 
...
mchirp_arr_H1 = [params_H1[i][0] for i in range(N_iter)]
eta_arr_H1 = [params_H1[i][1] for i in range(N_iter)]

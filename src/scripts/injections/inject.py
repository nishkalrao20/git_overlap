...
ht_b_H1, ht_b_L1, ht_b_V1 = inject_singles(mass1=20, mass2=30, spin1x=0, spin1y=0, spin1z=0.75, spin2x=0, spin2y=0, spin2z=0.25, luminosity_distance=400, iota=1.5, phase=2, ra=1.2, dec=1.25, psi=2.75, start_time=1126259462.4116447+0.25)

# Generating PAIRS

ht_H1, ht_L1, ht_V1 = inject_pairs(mass1_a=30, mass2_a=40, spin1x_a=0, spin1y_a=0, spin1z_a=0.5, spin2x_a=0, spin2y_a=0, spin2z_a=0.5, luminosity_distance_a=500, iota_a=2.5, phase_a=0, ra_a=2.2, dec_a=-1.25, psi_a=1.75, start_time_a=1126259462.4116447, mass1_b=20, mass2_b=30, spin1x_b=0, spin1y_b=0, spin1z_b=0.75, spin2x_b=0, spin2y_b=0, spin2z_b=0.25, luminosity_distance_b=400, iota_b=1.5, phase_b=2, ra_b=1.2, dec_b=1.25, psi_b=2.75, start_time_b=1126259462.4116447+0.25)

...
phase = np.random.uniform(0,2*np.pi, N_sampl)
...
with open('git_overlap/src/output/match_variations/match_phase/injections/GW Waveform A Meta Data.pkl', 'wb') as file:
...
for i in range(N_sampl):
    ...
    with open('git_overlap/src/output/match_variations/match_phase/injections/GW Waveform B Meta Data %s.pkl'%(i+1), 'wb') as file:

...
delta_tc = np.arange(-0.5, 0.6, 0.1)
N_sampl = len(delta_tc)
...
with open('git_overlap/src/output/match_variations/match_time_c/injections/GW Waveform A Meta Data.pkl', 'wb') as file:
...
for i in range(N_sampl):
    ...
    with open('git_overlap/src/output/match_variations/match_time_c/injections/GW Waveform B Meta Data %s.pkl'%(i+1), 'wb') as file:

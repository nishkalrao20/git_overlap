...
luminosity_distance_b = np.random.uniform(injection_a['luminosity_distance'][nmap_a]/3, injection_a['luminosity_distance'][nmap_a]*1.2, N_sampl)
...
with open('git_overlap/src/output/match_variations/match_snr/injections/GW Waveform A Meta Data.pkl', 'wb') as file:
...
for i in range(N_sampl):
    ...
    with open('git_overlap/src/output/match_variations/match_snr/injections/GW Waveform B Meta Data %s.pkl'%(i+1), 'wb') as file:

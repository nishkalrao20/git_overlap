...
with open('/home/nishkal.rao/git_overlap/src/scripts/pe_population/config_ml.ini', 'r') as base_file:
        ini_template = base_file.read() 
 
for i in tqdm(range(len(combinations))): 
    outdir = '/home/nishkal.rao/git_overlap/src/output/pe_population/pe/PE_ML_{}_{}_{}'.format(combinations[i][0], combinations[i][1], combinations[i][2]) 
    ...
    with open('/home/nishkal.rao/git_overlap/src/output/pe_population/pe/ini/config_pe_ml_{}_{}_{}.ini'.format(combinations[i][0], combinations[i][1], combinations[i][2]), 'w') as ini_file: 
        ini_file.write(ini_content)

    with open('/home/nishkal.rao/git_overlap/src/scripts/pe_population/submit_pe_ml.sh', 'a') as bash_file:
        bash_file.write('bilby_pipe git_overlap/src/output/pe_population/pe/ini/config_pe_ml_{}_{}_{}.ini --submit\n'.format(combinations[i][0], combinations[i][1], combinations[i][2]))
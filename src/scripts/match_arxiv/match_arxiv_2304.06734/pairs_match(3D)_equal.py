...
for k in range(N_sampl):
    ...
    fig.tight_layout()
    plt.savefig('git_overlap/src/output/match_arxiv/match_equal/outputs/PAIRS(3D)EQUAL %s.png'%(k+1))
    plt.close()

fig, ax = plt.subplots(1,3, figsize=(18, 6))
plt.suptitle('EQUAL: Chirp Mass $\\mathcal{M}$, Sym Mass Ratio $\\eta$ and Luminosity distance $d_L$, vs $\\Delta t_c$')
...
fig.tight_layout()
plt.savefig('git_overlap/src/output/match_arxiv/match_equal/PAIRS(3D)EQUAL.png')
plt.close()
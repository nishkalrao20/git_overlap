...
delta_tc = [-0.0212, -0.0098, -0.0070, 0.0011, 0.0161, 0.0304]
for i in range(len(delta_tc)):
	ht_H1, ht_L1, ht_V1 = inject_pairs(mass1_a=30, mass2_a=20, spin1x_a=0, spin1y_a=0, spin1z_a=0.5, spin2x_a=0, spin2y_a=0, spin2z_a=0.5, luminosity_distance_a=500, iota_a=2.5, phase_a=0, ra_a=2.2, dec_a=-1.25, psi_a=1.75, start_time_a=1126259462.4116447, mass1_b=60, mass2_b=9.11, spin1x_b=0, spin1y_b=0, spin1z_b=0.75, spin2x_b=0, spin2y_b=0, spin2z_b=0.25, luminosity_distance_b=3000, iota_b=1.5, phase_b=2, ra_b=1.2, dec_b=1.25, psi_b=2.75, start_time_b=1126259462.4116447+delta_tc[i])

	write_frame("git_overlap/src/output/match_arxiv/match_arxiv_2304.06734/match_symmetricandnotclose/injections/PAIRS_H1_%s.gwf"%(i+1), "H1:PyCBC_Injection", ht_H1)
	write_frame("git_overlap/src/output/match_arxiv/match_arxiv_2304.06734/match_symmetricandnotclose/injections/PAIRS_L1_%s.gwf"%(i+1), "L1:PyCBC_Injection", ht_L1)
	write_frame("git_overlap/src/output/match_arxiv/match_arxiv_2304.06734/match_symmetricandnotclose/injections/PAIRS_V1_%s.gwf"%(i+1), "V1:PyCBC_Injection", ht_V1)

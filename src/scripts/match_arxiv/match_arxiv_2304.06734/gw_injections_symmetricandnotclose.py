...
for i in range(N_sampl):
    injection_parameters_b.append({
        "mass_1": 60, # Primary redshifted mass of the heavier binary component in solar masses
        "mass_2": 9.11, # Secondary redshifted mass of the lighter binary component in solar masses
...
with open('git_overlap/src/output/match_arxiv/match_symmetricandnotclose/injections/GW Waveform A Meta Data.pkl', 'wb') as file:
...
for i in range(N_sampl):
    ...
    with open('git_overlap/src/output/match_arxiv/match_symmetricandnotclose/injections/GW Waveform B Meta Data %s.pkl'%(i+1), 'wb') as file:

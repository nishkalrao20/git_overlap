...
with open('git_overlap/src/output/match_arxiv/match_time/injections/GW Waveform A Meta Data.pkl', 'wb') as file:
...
for i in range(N_sampl):
    ...
    with open('git_overlap/src/output/match_arxiv/match_time/injections/GW Waveform B Meta Data %s.pkl'%(i+1), 'wb') as file:

...
delta_tc = [-0.1, -0.05, -0.025, 0, 0.025, 0.05, 0.1]
for i in range(len(delta_tc)):
    ...
    write_frame("git_overlap/src/output/match_arxiv/match_arxiv_2103.16225/match_time/injections/PAIRS_H1_%s.gwf"%(i+1), "H1:PyCBC_Injection", ht_H1)
    write_frame("git_overlap/src/output/match_arxiv/match_arxiv_2103.16225/match_time/injections/PAIRS_L1_%s.gwf"%(i+1), "L1:PyCBC_Injection", ht_L1)
    write_frame("git_overlap/src/output/match_arxiv/match_arxiv_2103.16225/match_time/injections/PAIRS_V1_%s.gwf"%(i+1), "V1:PyCBC_Injection", ht_V1)

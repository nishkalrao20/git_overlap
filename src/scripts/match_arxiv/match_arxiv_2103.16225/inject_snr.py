...
luminosity_distance = [402.2372317973936, 402.2372317973936*1.5, 402.2372317973936*2, 402.2372317973936*2.5, 402.2372317973936*3]
for i in range(len(luminosity_distance)):
    mass1_a, mass2_a = mconv(28.1, 0.806)
    mass1_b, mass2_b = mconv(28.1, 0.806)
    ...
    ht_H1, ht_L1, ht_V1 = inject_pairs(mass1_a=mass1_a, mass2_a=mass2_a, spin1x_a=lframe_a['spin1x'], spin1y_a=lframe_a['spin1y'], spin1z_a=lframe_a['spin1z'], spin2x_a=lframe_a['spin2x'], spin2y_a=lframe_a['spin2y'], spin2z_a=lframe_a['spin2z'], luminosity_distance_a=402.2372317973936, iota_a=lframe_a['inclination'], phase_a=1.4698141271696548, ra_a=1.4872165580410979, dec_a=-1.2571099207652874, psi_a=1.7952004204194505, start_time_a=1126259462.4116447, mass1_b=mass1_b, mass2_b=mass2_b, spin1x_b=lframe_b['spin1x'], spin1y_b=lframe_b['spin1y'], spin1z_b=lframe_b['spin1z'], spin2x_b=lframe_b['spin2x'], spin2y_b=lframe_b['spin2y'], spin2z_b=lframe_b['spin2z'], luminosity_distance_b=luminosity_distance[i], iota_b=lframe_b['inclination'], phase_b=1.4698141271696548, ra_b=1.4872165580410979, dec_b=-1.2571099207652874, psi_b=1.7952004204194505, start_time_b=1126259462.4116447+0.025)
    
    write_frame("git_overlap/src/output/match_arxiv/match_arxiv_2103.16225/match_snr/injections/PAIRS_H1_%s.gwf"%(i+1), "H1:PyCBC_Injection", ht_H1)
    write_frame("git_overlap/src/output/match_arxiv/match_arxiv_2103.16225/match_snr/injections/PAIRS_L1_%s.gwf"%(i+1), "L1:PyCBC_Injection", ht_L1)
    write_frame("git_overlap/src/output/match_arxiv/match_arxiv_2103.16225/match_snr/injections/PAIRS_V1_%s.gwf"%(i+1), "V1:PyCBC_Injection", ht_V1)

...
waveform_metadata_a = pickle.load(open('git_overlap/src/output/match_arxiv/match_time/injections/GW Waveform A Meta Data.pkl', 'rb'))   # Importing Waveform Meta Data
...
for k in range(N_sampl):
    waveform_metadata_b.append(pickle.load(open('git_overlap/src/output/match_arxiv/match_time/injections/GW Waveform B Meta Data %s.pkl'%(k+1), 'rb')))   # Importing Waveform Meta Data
...
for k in range(N_sampl):
    ...
    fig.tight_layout()
    plt.savefig('git_overlap/src/output/match_arxiv/match_time/outputs/PAIRS(2D)TIME %s.png'%(k+1))
    plt.close()
...
fig.tight_layout()
plt.savefig('git_overlap/src/output/match_arxiv/match_time/PAIRS(2D)TIME.png')
plt.close()
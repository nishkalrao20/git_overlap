...
# 2 Dimensional (Chirp mass, Symmetric mass ratio) Nelder Mead maximization of Match on PAIRS waveforms, by varying SNR of SINGLES_B
...
for k, idx in enumerate(indices):
    ...
    np.savetxt('/home/nishkal.rao/git_overlap/src/output/match_ml_ecc_population/outputs/PAIRS(2D) %s.csv'%(idx), np.column_stack((match_f_H1, mchirpf_H1, etaf_H1)), delimiter=',')

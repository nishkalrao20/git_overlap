...
log_mismatch, match, mchirp, eta, spin1z, spin2z, log_mismatch_arr, match_arr = np.vectorize(overlap_ff, otypes=[object], excluded={4,5,6,11,12,13})(mass_1_a, mass_2_a, a_1_a, a_2_a, luminosity_distance_a, phase_a, psd, mass_1_b, mass_2_b, a_1_b, a_2_b, luminosity_distance_b, phase_b, N_iter)

mchirp_aff, eta_aff, spin1z_aff, spin2z_aff, mchirp_bff, eta_bff, spin1z_bff, spin2z_bff  = mchirp_af[np.argmin(log_mismatch_arr_a)], eta_af[np.argmin(log_mismatch_arr_a)], spin1z_af[np.argmin(log_mismatch_arr_a)], spin2z_af[np.argmin(log_mismatch_arr_a)],  mchirp_bf[np.argmin(log_mismatch_arr_b)], eta_bf[np.argmin(log_mismatch_arr_b)], spin1z_bf[np.argmin(log_mismatch_arr_b)], spin2z_bf[np.argmin(log_mismatch_arr_b)]
...
print('Recovered Singles - A: Chirp Mass: %s, Sym. Ratio: %s, Spin1z: %s, Spin2z: %s, Mass1: %s, Mass2: %s'%(np.round(mchirp_aff, 2), np.round(eta_aff, 2), np.round(spin1z_aff, 2), np.round(spin2z_aff, 2), np.round(mass_1_af, 2), np.round(mass_2_af, 2)))
print('Recovered Singles - B: Chirp Mass: %s, Sym. Ratio: %s, Spin1z: %s, Spin2z: %s, Mass1: %s, Mass2: %s'%(np.round(mchirp_bff, 2), np.round(eta_bff, 2), np.round(spin1z_bff, 2), np.round(spin2z_bff, 2), np.round(mass_1_bf, 2), np.round(mass_2_bf, 2)))
print('Recovered Overlap: Chirp Mass: %s, Sym. Ratio: %s, Spin1z: %s, Spin2z: %s, Mass1: %s, Mass2: %s'%(np.round(mchirp_f, 2), np.round(eta_f, 2), np.round(spin1z_f, 2), np.round(spin2z_f, 2), np.round(mass_1, 2), np.round(mass_2, 2)))